...
The project is implemented using the Java programming language and follows the Object-Oriented Programming (OOP) approach.

The game includes core Tetris mechanics such as Tetromino rotation, line clearing, collision detection, scoring system, and increasing game difficulty.
